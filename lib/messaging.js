// Retry helper for chrome.runtime.sendMessage — works around the MV3 service-worker
// wake-up race where the background worker hasn't finished restarting yet.
(function (root) {
